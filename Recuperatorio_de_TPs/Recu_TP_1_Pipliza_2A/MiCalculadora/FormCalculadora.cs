...
namespace MiCalculadora
{
    public partial class FormCalculadora : Form
    {
        ...
        private void btnOperar_Click(object sender, EventArgs e)
        {
            ...
            if (this.txtNumero1.Text != "0" && this.cmbOperador.Text == "/" && this.txtNumero2.Text == "0") 
            {
                MessageBox.Show("La división por (0) devuelve un valor mínimo.", "", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
        }
        ...
        private void txtNumero1_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            //{
            //    e.Handled = true;
            //    MessageBox.Show("Solo se admiten números y números con [ , ]", "Alerta", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
            //}
        }
