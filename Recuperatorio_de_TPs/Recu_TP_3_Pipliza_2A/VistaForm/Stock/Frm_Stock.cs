...
namespace VistaForm
{
    public partial class Frm_Stock : Form
    {
        ...
        private void deposito_btnAgregarClick(object sender, EventArgs e)
        {
            try
            {
                DepositoP deposito1 = new DepositoP(int.Parse(DepositoP_textBox_NroRack.Text), (DepositoP.Formato)lstBoxDepositos_Tipo.SelectedItem, DepositoP_textBox_TipoPapel.Text, int.Parse(DepositoP_textBox_Edicion.Text), DepositoP_textBox_Editor.Text, DepositoP_textBox_Codigo.Text, int.Parse(DepositoP_textBox_Cantidad.Text));
